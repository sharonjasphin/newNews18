 ...
 */
public class MobileUrduArticleConsumptionPage {

	WebDriverActions webDriverActions = new WebDriverActions();
	GenericUtility genericUtility= new GenericUtility();
	SoftAssert assrt =new SoftAssert();
	public WebDriver driver;
	public MobileUrduArticleConsumptionPage(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	/*Links of all latest article in latest section*/
	@FindBy(xpath = "//div[contains(@class,'chmpntpnwshd')]/h1/a[not (contains(@href,'/videos/'))]")
	private List<WebElement> latestArtcleLst;

	/*First published date mentioned in latest article*/
	@FindBy(xpath = "(//ul[contains(@class,'newbyeline-agency')]/li/time)")
	...
	/*First published date mentioned in latest article*/
	@FindBy(xpath = "(//ul[contains(@class,'newbyeline')]//time)[1] | (//ul[contains(@class,'artcl_byeline')]//time)[1] | (//div[contains(@class,'byln txtlgtgrey')]//span)[1] | ((//div[contains(@class,'newdscrtcardbox_content')])[1]/div)[1] | (//ul[contains(@class,'newbyeline-agency')]/li)[2]")
