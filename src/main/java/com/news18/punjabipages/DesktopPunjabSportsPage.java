 ...
 *This Class Contains elements and business logics for Punjab Sports Page
 */
public class DesktopPunjabSportsPage {
	...
	public DesktopPunjabSportsPage(WebDriver driver) {
		this.driver = driver;
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to click on First Article of Punjab sports Page 
	 */
