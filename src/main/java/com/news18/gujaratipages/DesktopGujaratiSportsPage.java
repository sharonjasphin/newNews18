 ...
 *This Class Contains elements and business logics for Gujarati Sports Page
 */
public class DesktopGujaratiSportsPage {
	...
	public  DesktopGujaratiSportsPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath = "//div[contains(@class,'news_page_left')]//a[contains(@href,'live-day')]")
