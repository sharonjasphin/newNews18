...
/**
 * @author Abhishek
 *This Class Contains elements and business logics for Odia Desktop Photogallery Consumption Page
 */
public class DesktopOdiaPhotogalleryConsumptionPage {
	...
	public DesktopOdiaPhotogalleryConsumptionPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath ="//div[contains(@class,'clearfix')]//ul[contains(@class,'tprgt fright')]//h2/a")
