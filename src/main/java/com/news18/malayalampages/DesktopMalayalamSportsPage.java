 ...
 *This Class Contains elements and business logics for Malayalam Sports Page
 */
public class DesktopMalayalamSportsPage {
	...
	public DesktopMalayalamSportsPage(WebDriver driver) {
		this.driver = driver;
