...
/**
 * @author Abhishek
 *This Class Contains elements and business logics for lokmat Desktop Photogallery Consumption Page
 */
public class DesktopLokmatPhotogalleryConsumptionPage {
	...
	public  DesktopLokmatPhotogalleryConsumptionPage(WebDriver driver) {
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	/*Homepage First article Link  is present below the Line Two Tag  Menu in RHS*/
	@FindBy(xpath ="//div[contains(@class,'pht-tp')]//ul[contains(@class,'pht-tprgt')]/li/h2/a")
	...
	public void clickPhotogalleryFirstArticle() {
		try {
			...
			Logs.error(getClass(), "Exception in First Article of Photo gallery page",e);
		}
	}
