...
/**
 * @author AnupamGupta
 * This Class Contains elements and business logics for kannada Mobile sports Page
 */
public class MobileKannadaSportsPage {

	public WebDriver driver;
	WebDriverActions webDriverActions = new WebDriverActions();

	public  MobileKannadaSportsPage(WebDriver driver) {
		this.driver = driver;
