...
public class AMPHindiSanityLandingPage {
	...
	public void verifyHealthImgNavigation(String serverType) {
		...
		webDriverActions.softScrollToElement(foodTitle);
		webDriverActions.continuousScrollTillElement(healthFitnessTitle,10);
		String actualUrl =	webDriverActions.getAttribute("href", healthFitnessTitle);
	 ...
	 * This Method is use to verify Line One section elements By clicking on it.
	 */
	public void verfyLineOneSectionAndSearchIcon(String serverType)
	{
		webDriverActions.waitForPageToLoad();
	...
	public ArrayList<String> verifyCricketNextArticleLnk(String serverType)
	{
		...
		webDriverActions.waitForPageToLoad();
		webDriverActions.waitForElement(1000);
		webDriverActions.softWaitForElementVisibility(cricketArticleWidgetLnk, 3);
