...
/**
 * @author Abhishek
 *This Class Contains elements and business logics for Telugu Desktop Photogallery Consumption Page
 */
public class DesktopTeluguPhotogalleryConsumptionPage {
	...
	public DesktopTeluguPhotogalleryConsumptionPage(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(xpath="//div[contains(@class,'pht-artcl-share fright')]/a | //ul[contains(@class,'-share')]/a")
	private List<WebElement> socialShareIconsLnk;

	/*All share icons division*/
	@FindBy(xpath = "//div[contains(@class,'pht-artcl-share fright')] | //ul[contains(@class,'-share')]")
