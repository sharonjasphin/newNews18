 ...
 *This Class Contains elements and business logics for telugu videos Page
 */
public class DesktopTeluguVideosPage {
	...
	public  DesktopTeluguVideosPage(WebDriver driver) {
		this.driver = driver;
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to click on First Article of Telugu video Page 
	 */
