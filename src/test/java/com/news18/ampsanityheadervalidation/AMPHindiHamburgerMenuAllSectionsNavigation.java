 ...
 * @author DanishR
 */
public class AMPHindiHamburgerMenuAllSectionsNavigation extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author DanishR
	 * This method is used to validate Navigations for all Sections Present In Hamburger Menu of Mobile Hindi Home Page.
	 */
	@Test
	public void HamburgerMenuAllSectionsNavigation () {
		pages.ampHindiSanityLandingPage.HamburgerMenuAllSectionsNavigation(serverType);
	}
}
