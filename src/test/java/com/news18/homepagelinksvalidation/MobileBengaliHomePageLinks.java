...
/**
 * @author DanishR
 * This class validate URLs present on the Mobile Bengali HomePage 
 */
public class MobileBengaliHomePageLinks extends MobileCommonConfig {

	/**
	 * This method is used to navigate to Mobile Bengali News18 Home Page URL which is fetching from Property File
