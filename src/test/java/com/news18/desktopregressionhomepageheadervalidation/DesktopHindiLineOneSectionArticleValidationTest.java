 ...
 */
public class DesktopHindiLineOneSectionArticleValidationTest extends DesktopCommonConfig {
	...
	public void lineOneSectionArticleValidation () {
		pages.desktopHindiLandingPage.verifyLineOneArticleSection(serverType);
	}
}
