 ...
 */
public class DesktopKannadaLineOneHamburgerMenuValidationTest extends DesktopCommonConfig {
	...
	public void hamburgerMenuValidation () {
		pages.desktopKannadaLandingPage.verfyLineOneHamburgerMenu(serverType);
	}
