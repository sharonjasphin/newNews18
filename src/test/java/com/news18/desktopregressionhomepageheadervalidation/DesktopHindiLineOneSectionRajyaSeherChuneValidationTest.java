 ...
 */
public class DesktopHindiLineOneSectionRajyaSeherChuneValidationTest extends DesktopCommonConfig {
	...
	public void verifyLineOneSectionRajyaSeherChune () {
		pages.desktopHindiLandingPage.verifyLineOneSectionRajyaSeherChune(serverType);
	}
}
