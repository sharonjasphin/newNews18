 ...
 */
public class DesktopKannadaLineOneSearchSectionValidationTest extends DesktopCommonConfig {
	 ...
	 */
	@Test
	public void lineOneSearchSectionValidation () {
		pages.desktopKannadaLandingPage.verfyLineOneSearchSection(serverType);
	}
}
