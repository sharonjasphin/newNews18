 ...
 * 
 */
public class DesktopGujaratiLineOneChooseYourDistrictValidation extends DesktopCommonConfig {
	...
	public void verifyLineOneSectionRajyaSeherChune () {
		pages.desktopGujaratiLandingPage.verifyLineOneSectionChooseYourDistrict(serverType);
	}
}
