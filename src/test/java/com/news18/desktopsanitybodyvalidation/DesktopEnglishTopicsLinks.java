 ...
 */
public class DesktopEnglishTopicsLinks extends DesktopCommonConfig {
...
//	@BeforeMethod
	 ...
	 */
	@Test
	public void englishHomePage() throws Throwable {
		pages.desktopSanityLandingPage.topicsLinks(serverType);
	}
}
