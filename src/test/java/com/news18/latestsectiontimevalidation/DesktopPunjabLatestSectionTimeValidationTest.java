 ...
 * This Test Class contains scripts to verify time difference between Desktop Latest Punjab Section Article's Time with System time and 
 * check whether the difference is less than 15 min by clicking on the Article and fetching the date and time there.
 */
public class DesktopPunjabLatestSectionTimeValidationTest extends DesktopCommonConfig {
...
//	}
	...
	public void verifyLatestNewsUpdatedTime()
	{
		...
		pages.verifyLatestNewsUpdatedTime.desktopVerifyLatestNewsUpdatedTime(pages.desktopPunjabArticleConsumptionPage.getLatestArtcleLst(), pages.desktopPunjabArticleConsumptionPage.getFirstPublishedDate());
	}
