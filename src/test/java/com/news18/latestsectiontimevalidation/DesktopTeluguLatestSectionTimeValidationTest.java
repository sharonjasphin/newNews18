 ...
 * This Test Class contains scripts to verify time difference between Desktop Latest Telugu Section Article's Time with System time and 
 * check whether the difference is less than 15 min by clicking on the Article and fetching the date and time there.
 */
public class DesktopTeluguLatestSectionTimeValidationTest extends DesktopCommonConfig {
...
//	}
	...
	{
		pages.desktopTeluguLandingPage.latestSection();//It will navigate to latest Section
		//It will Verify the top Stories article updated Time
		pages.verifyLatestNewsUpdatedTime.desktopVerifyLatestNewsUpdatedTime(pages.desktopTeluguArticleConsumptionPage.getLatestArtcleLst(), pages.desktopTeluguArticleConsumptionPage.getFirstPublishedDate());
	}
