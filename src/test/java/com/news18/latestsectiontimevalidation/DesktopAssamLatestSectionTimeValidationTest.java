 ...
 * This Test Class contains scripts to verify time difference between Desktop Latest Assam Section Article's Time with System time and 
 * check whether the difference is less than 15 min by clicking on the Article and fetching the date and time there.
 */
public class DesktopAssamLatestSectionTimeValidationTest extends DesktopCommonConfig {
...
//	}
	...
	public void verifyLatestNewsUpdatedTime()
	{
		...
		navigateToUrl(fileUtility.readDataFromPropertyFile("latestAssamUrl"));
		pages.verifyLatestNewsUpdatedTime.desktopVerifyLatestNewsUpdatedTime(pages.desktopAssamArticleConsumptionPage.getLatestArtcleLst(), pages.desktopAssamArticleConsumptionPage.getFirstPublishedDate());
	}
