 ...
 * This Test Class contains scripts to verify time difference between Mobile Latest bengali Section Article's Time with System time and 
 * check whether the difference is less than 15 min by clicking on the Article and fetching the date and time there.
 *
 */
public class MobileBengaliLatestSectionTimeValidationTest extends MobileCommonConfig {
...
//	}
	...
	public void verifyLatestNewsUpdatedTime() 
	{
		...
		pages.mobileBengaliArticleConsumptionPage.mobileVerifyLatestNewsUpdatedTime();
	}
}
