 ...
 *This Test Class contains scripts to verify time difference between Desktop Latest Kannada Section Article's Time with System time and 
 * check whether the difference is less than 15 min by clicking on the Article and fetching the date and time there.
 */
public class DesktopKannadaLatestSectionTimeValidationTest extends DesktopCommonConfig {


	/**
	 * This method is used to navigate to News18 Home Page for Kannada Language URL which is fetching from Property File
	 *  URL-https://kannada.news18.com/news/
	 */
	//	@BeforeMethod
	//	public void navigateToNews18Homepage()
	//	{
	//		navigateToUrl(fileUtility.readDataFromPropertyFile("latestKannadaUrl"));
	//	}
	...
	public void verifyLatestNewsUpdatedTime()
	{
		...
		pages.desktopKannadaArticleConsumptionPage.desktopVerifyLatestNewsUpdatedTime();
	}
