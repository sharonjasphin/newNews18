 ...
 * This Test Class contains scripts to verify time difference between Mobile Latest lokmat Section Article's Time with System time and 
 * check whether the difference is less than 15 min by clicking on the Article and fetching the date and time there.
 *
 */
public class MobileLokmatLatestSectionTimeValidationTest extends MobileCommonConfig {

	
	/**
	 *This method is used to navigate to News18 Home Page for lokmat Language URL which is fetching from Property File
	 *URL-https://lokmat.news18.com/news/
	 */
//	@BeforeMethod
...
//	}
	...
	public void verifyLatestNewsUpdatedTime() 
	{
		...
		pages.verifyLatestNewsUpdatedTime.mobileVerifyLatestNewsUpdatedTime(pages.mobileLokmatArticleConsumptionPage.getLatestArtcleLst());
	}
}
