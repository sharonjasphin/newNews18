 ...
 * This Test Class contains scripts to verify time difference between Mobile Latest kannada Section Article's Time with System time and 
 * check whether the difference is less than 15 min by clicking on the Article and fetching the date and time there.
 *
 */
public class MobileKannadaLatestSectionTimeValidationTest extends MobileCommonConfig {
...
//	}
	...
	public void verifyLatestNewsUpdatedTime()
	{
		...
		pages.mobileKannadaArticleConsumptionPage.mobileVerifyLatestNewsUpdatedTime();
	}
}
