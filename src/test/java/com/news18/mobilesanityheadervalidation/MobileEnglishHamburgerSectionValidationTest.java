 ...
 */
public class MobileEnglishHamburgerSectionValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate Section Drop down Present In Hamburger Menu of Mobile English Home Page.
	 */
	@Test
	public void hamburgerMenuSectionValidation () {
		pages.mobileSanityLandingPage.verifyHamburgerMenuSectionDropdown(serverType);
	}
}
