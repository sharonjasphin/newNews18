 ...
 * @author DanishR
 */
public class MobileHindiHamburgerMenuMobileTech extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author DanishR
	 * This method is used to validate Mobile Tech Present In Hamburger Menu of Mobile Hindi Home Page.
	 */
	@Test
	public void hamburgerMenuMobileTechValidation () {
		pages.mobileHindiSanityLandingPage.hamburgerMenuMobileTechLinks(serverType);
	}
}
