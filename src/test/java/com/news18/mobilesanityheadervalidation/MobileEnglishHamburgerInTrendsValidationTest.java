 ...
 */
public class MobileEnglishHamburgerInTrendsValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate In Trends Drop down Present In Hamburger Menu of Mobile English Home Page.
	 */
	@Test
	public void hamburgerInTrendsValidation () {
		pages.mobileSanityLandingPage.verifyHamburgerInTrendsSection(serverType);
	}
}
