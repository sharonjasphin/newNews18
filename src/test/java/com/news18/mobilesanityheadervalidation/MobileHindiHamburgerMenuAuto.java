 ...
 * @author DanishR
 */
public class MobileHindiHamburgerMenuAuto extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author DanishR
	 * This method is used to validate Auto Section Present In Hamburger Menu of Mobile Hindi Home Page.
	 */
	@Test
	public void hamburgerMenuAutoSectionValidation () {
		pages.mobileHindiSanityLandingPage.hamburgerMenuAutoSection(serverType);
	}
}
