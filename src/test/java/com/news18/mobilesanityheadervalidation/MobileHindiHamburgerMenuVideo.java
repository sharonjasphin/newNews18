 ...
 * @author DanishR
 */
public class MobileHindiHamburgerMenuVideo extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author DanishR
	 * This method is used to validate Video Section Present In Hamburger Menu of Mobile Hindi Home Page.
	 */
	@Test
	public void hamburgerMenuVideoSectionValidation () {
		pages.mobileHindiSanityLandingPage.hamburgerMenuVideoSection(serverType);
	}
}
