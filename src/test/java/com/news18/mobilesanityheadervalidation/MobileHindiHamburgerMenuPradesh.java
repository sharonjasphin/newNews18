 ...
 * @author DanishR
 */
public class MobileHindiHamburgerMenuPradesh extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author DanishR
	 * This method is used to validate Pradesh Section Present In Hamburger Menu of Mobile Hindi Home Page.
	 */
	@Test
	public void hamburgerMenuPradeshLinks () {
		pages.mobileHindiSanityLandingPage.hamburgerMenuPradeshLinks(serverType);
	}
}
