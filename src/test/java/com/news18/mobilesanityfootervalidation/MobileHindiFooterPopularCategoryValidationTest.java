 ...
 */
public class MobileHindiFooterPopularCategoryValidationTest extends MobileCommonConfig {
	...
	public void footerPopularCategoryValidation () {
		pages.mobileHindiSanityLandingPage.verifyFooterPopularCategorySection(serverType);
	}
}
