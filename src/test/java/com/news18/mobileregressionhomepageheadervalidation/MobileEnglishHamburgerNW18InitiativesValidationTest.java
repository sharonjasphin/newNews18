 ...
 */
public class MobileEnglishHamburgerNW18InitiativesValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate News 18 Initiatives Drop down Present In Hamburger Menu of Mobile English Home Page.
	 */
	@Test
	public void hamburgerNw18InitiativesValidation () {
		pages.mobileLandingPage.verifyHamburgerNews18InitiativesDropdown();
	}
}
