 ...
 */
public class MobileEnglishHamburgerKnowUsValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate News 18 Know Us Drop down Present In Hamburger Menu of Mobile English Home Page.
	 */
	@Test
	public void hamburgerGroupSitesValidation () {
		pages.mobileLandingPage.verifyHamburgerKnowUsDropdown(serverType);
	}
}
