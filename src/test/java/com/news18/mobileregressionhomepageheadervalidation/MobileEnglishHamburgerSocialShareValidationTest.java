 ...
 */
public class MobileEnglishHamburgerSocialShareValidationTest extends MobileCommonConfig {
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate Social Share Drop down Present In Hamburger Menu of Mobile English Home Page.
	 */
	@Test
	public void hamburgerSocialShareValidation () {
		pages.mobileLandingPage.verifyHamburgerSocialShareIconSection();
	}
}
