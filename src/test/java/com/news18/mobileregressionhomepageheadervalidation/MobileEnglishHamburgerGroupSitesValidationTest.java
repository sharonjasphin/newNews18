 ...
 */
public class MobileEnglishHamburgerGroupSitesValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate News 18 GroupSites Drop down Present In Hamburger Menu of Mobile English Home Page.
	 */
	@Test
	public void hamburgerGroupSitesValidation () {
		pages.mobileLandingPage.verifyHamburgerNews18GroupSitesDropdown();
	}
}
