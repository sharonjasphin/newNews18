...
public class DesktopMalayalamMetaTag extends DesktopCommonConfig {
...
//	@BeforeMethod
	...
	public void verifyMetatagInHomeArticle() {
		pages.desktopMalayalamLandingPage.clickOnFirstArticleHomePage();//Click on First Article Of malayalam Home Page
	...
	public void verifyMetatagInPhotoGalleryArticle() {
		...
		pages.desktopMalayalamPhotogalleryConsumptionPage.clickPhotogalleryFirstArticle();//Click on First Article Of photogallery consumption Page
		pages.desktopMetaTagValidation.verifyMetaTag();//Verify Robots text and max-image-preview:large text is present or not 
	}	
	...
	/**
	 * @author Abhishek Raj
	 * This method is used to click on First Live Blog Article of News18 Malayalam Home Page and
	 * Validate The Robots text and max-image-preview:large text getting from the view
	 * page Source Code Page
	 */
	@Test
