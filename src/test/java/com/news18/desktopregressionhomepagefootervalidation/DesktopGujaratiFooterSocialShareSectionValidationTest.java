 ...
 */
public class DesktopGujaratiFooterSocialShareSectionValidationTest extends DesktopCommonConfig {
	...
	public void footerGroupSitesSectionValidation () {
		pages.desktopGujaratiLandingPage.verifyFooterSocialSectionValidation();
	}
}
