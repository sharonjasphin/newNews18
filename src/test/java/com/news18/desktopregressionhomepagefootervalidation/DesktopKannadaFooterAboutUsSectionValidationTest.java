 ...
 */
public class DesktopKannadaFooterAboutUsSectionValidationTest extends DesktopCommonConfig {
	...
	public void footerAboutUsSectionValidation () {
		pages.desktopKannadaLandingPage.verifyFooterAboutUSSection(serverType);
	}
}
