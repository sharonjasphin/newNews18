 ...
 */
public class DesktopHindiFooterLineTwoSectionValidationTest extends DesktopCommonConfig {
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate Footer Logo Sections present In Hindi News18 HomePage
	 */
	@Test
	public void footerLineTwoSectionValidation () {
		pages.desktopHindiLandingPage.verfyFooterLineTwoSection();
	}
}
