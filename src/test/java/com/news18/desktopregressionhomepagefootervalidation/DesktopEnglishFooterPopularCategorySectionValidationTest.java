 ...
 */
public class DesktopEnglishFooterPopularCategorySectionValidationTest extends DesktopCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate Footer Popular Category Sections present In English News18 HomePage
	 */
	@Test
	public void footerPopularCategorySectionValidation () {
		pages.desktopLandingPage.verfyFooterPopularCategorySection(serverType);
	}
}
