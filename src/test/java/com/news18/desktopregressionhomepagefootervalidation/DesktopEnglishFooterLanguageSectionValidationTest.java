 ...
 */
public class DesktopEnglishFooterLanguageSectionValidationTest extends DesktopCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate Footer Language Sections present In English News18 HomePage
	 */
	@Test
	public void footerLanguageSectionValidation () {
		pages.desktopLandingPage.verfyFooterLanguageSection();
	}
}
