 ...
 */
public class DesktopGujaratiFooterNews18GroupsitesSectionValidationTest extends DesktopCommonConfig {
	...
	public void footerGroupSitesSectionValidation () {
		pages.desktopGujaratiLandingPage.verifyFooterNews18GroupSitesSection();
	}
}
