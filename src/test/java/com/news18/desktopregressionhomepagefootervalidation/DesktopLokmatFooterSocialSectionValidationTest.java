 ...
 */
public class DesktopLokmatFooterSocialSectionValidationTest extends DesktopCommonConfig {
...
//	@BeforeMethod
	 ...
	 */
	@Test
	public void footerSocialSectionValidation () {
		pages.desktopLokmatLandingPage.verifyFooterSocialSection(serverType);
	}
}
