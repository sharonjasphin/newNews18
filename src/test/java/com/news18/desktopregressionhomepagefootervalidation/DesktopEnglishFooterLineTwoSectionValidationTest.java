 ...
 */
public class DesktopEnglishFooterLineTwoSectionValidationTest extends DesktopCommonConfig {
...
//	@BeforeMethod
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate Footer Logo Sections present In English News18 HomePage
	 */
	@Test
	public void footerLineTwoSectionValidation () {
		pages.desktopLandingPage.verfyFooterLineTwoSection();
	}
}
