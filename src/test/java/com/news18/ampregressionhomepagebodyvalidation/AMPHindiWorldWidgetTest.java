...
//	@BeforeMethod
	...
	public void verifyHindiHomePageWorldWidgetImg() {
		pages.ampHindiLandingPage.verifyWorldWidgetImg(this.serverType);        
	}
	...
	public void verifyHindiHomePageWorldWidgetArticle() {
		pages.ampHindiLandingPage.verifyWorldWidgetArticle(this.serverType);        
	}
	...
	public void verifyHindiHomePageWorldWidgetMoreLnk() {
		pages.ampHindiLandingPage.verifyMoreWorldLnk(this.serverType);        
	}
	...
	public void verifyHindiHomePageWorldWidget() {
		pages.ampHindiLandingPage.verifyWorldWidget(this.serverType);        
	}
}
