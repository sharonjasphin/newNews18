...
//	@BeforeMethod
	...
	/**
	 * This method is used to verify the healthSectionHeadline test section present at the RHS of the Home page
	 */
	@Test
	public void healthSectionHeadline() {
		pages.ampHindiLandingPage.verifyHealthSectionHeadline(serverType);
	}
	...
	public void healthArticleNavigation() {
		pages.ampHindiLandingPage.verifyhealthArticleNavigation(serverType);
	}
	
	/**
	 * This method is used to verify the HealthReadMore test section present at the RHS of the Home page
	 */
	@Test
	public void healthReadMore() {
		pages.ampHindiLandingPage.verifyHealthReadMore(serverType);
	}
}
