 ...
 */
public class DesktopHindiFooterSocialSectionValidationTest extends DesktopCommonConfig {
	...
	public void footerTrendingTopicsSectionValidation () {
		pages.desktopHindiSanityLandingPage.verfyFooterSocialSectionValidation(serverType);
	}
}
