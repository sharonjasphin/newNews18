 ...
 * Page for Gujarati Language in Desktop Mode 
 */
public class DesktopGujaratiOutbrainTest extends DesktopCommonConfig 
{
...
//	}
	 ...
	 * is displayed/Loading in News18 HomePage for Gujarati Language
	 */
	@Test
	...
	{
		pages.desktopGujaratiLandingPage.clickOnLiveBlogArticleHomePage();		//Click on First LiveBlog Article
		pages.desktopOutbrainValidation.verifyArticleOutbarinContent();
	}
	...
	{
		pages.desktopGujaratiLandingPage.clickOnFirstTopicLnkTrendingTopics();
		pages.desktopOutbrainValidation.verifyArticleOutbarinContent();
	}
}
