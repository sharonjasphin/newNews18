 ...
 * Page for English Language in Desktop Mode 
 */
public class DesktopEnglishOutbrainTest extends DesktopCommonConfig {
...
//	}
	...
	{
		pages.desktopLandingPage.clickOnFirstArticleHomePage();			// Click on First Article excluding LiveBlog Article
	...
	{
		pages.desktopLandingPage.clickOnFirstLiveBlogArticleHomePage(); 	//Click on First LiveBlog Article
		pages.desktopOutbrainValidation.verifyArticleOutbarinContent();
	}
	...
	public void verifyPhotoGalleryOutbrain()
	{
		...
		pages.desktopphotoGalleryConsumptionPage.navigateToOldPhotogalleryFirstArticle();			// Click on First PhotoGallery Article
		pages.desktopOutbrainValidation.verifyArticleOutbarinContent();
	}
	...
	/**
	 * @author VipinKumarGawande
	 * This method is used to click on Topics links in News18 HomePage and Verify the Promoted Content 
	 * Ads and OutBrain Content is displayed/Loading in Topics Article Consumption Page  
	 */
	@Test
	public void verifyTopicsOutbrain()
	{
		pages.desktopLandingPage.clickOnFirstTopicLnkTrendingTopics();
		pages.desktopOutbrainValidation.verifyArticleOutbarinContent();
	}
}