 ...
 * like HomePage , Article Consumption Page , PhotoGallery Consumption Page for Telugu Language in Mobile Mode
 */
public class MobileTeluguOutbrainTest extends MobileCommonConfig {
