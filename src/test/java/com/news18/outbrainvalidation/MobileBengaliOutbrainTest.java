 ...
 * like HomePage , Article Consumption Page , PhotoGallery Consumption Page for Bengali Language in Mobile Mode
 */
public class MobileBengaliOutbrainTest extends MobileCommonConfig {
...
//	 */
//	@BeforeMethod
//	public void navigateToNews18BengaliHomepage()
//	{
...
//	}
	...
	{
		pages.mobileBengaliLandingPage.clickOnFirstArticleBengaliHomePage();	// Click on First Article excluding LiveBlog Article
		pages.mobileOutbrainValidation.verifyArticleOutbrainContent();
	}
	...
	{
		pages.mobileBengaliLandingPage.clickOnLiveBlogArticleHomePage();	// Click on First LiveBlog Article
		pages.mobileOutbrainValidation.verifyArticleOutbrainContent();
	}
	/**
	 * @author VipinKumarGawande
	...
	{
		pages.mobileBengaliLandingPage.clickOnPhotoSection();								// Click on Photos Section
		pages.mobileBengaliPhotogalleryConsumptionPage.clickPhotogalleryFirstArticle();	// Click on First PhotoGallery Article
		pages.mobileOutbrainValidation.verifyArticleOutbrainContent();
	}
}