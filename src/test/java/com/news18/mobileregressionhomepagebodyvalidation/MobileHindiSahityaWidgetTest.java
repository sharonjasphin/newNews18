...
//	@BeforeMethod
	...
	{
		pages.mobileHindiLandingPage.verifySahityaArticleWidget(serverType);
	}
	...
	{
		pages.mobileHindiLandingPage.verifySahityaMoreNewsWidget(serverType);
	}
	...
	{
		pages.mobileHindiLandingPage.verifySahityaTitleWidget(serverType);
	}
}