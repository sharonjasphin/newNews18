 ...
 */
public class MobileEnglishFooterPopularCategoryValidationTest extends MobileCommonConfig {
...
//	@BeforeMethod
	...
	public void footerPopularCategoryValidation () {
		pages.mobileLandingPage.verifyFooterPopularCategorySection(serverType);
	}
}
