 ...
 */
public class MobileEnglishFooterFollowUsAndDownloadAppValidationTest extends MobileCommonConfig {
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate the Social SHare Section Present at footer of Mobile English Home Page.
	 */
	@Test
