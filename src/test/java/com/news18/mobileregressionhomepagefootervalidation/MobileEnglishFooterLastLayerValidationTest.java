 ...
 */
public class MobileEnglishFooterLastLayerValidationTest extends MobileCommonConfig {
	...
	/**
	 * @author SanjeebKumarPati
	 * This method is used to validate the Footer Last Section Present at footer of Mobile English Home Page.
	 */
	@Test
