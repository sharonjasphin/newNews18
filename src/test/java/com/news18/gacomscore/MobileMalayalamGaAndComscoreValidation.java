 ...
 * of Mobile Malayalam
 */
public class MobileMalayalamGaAndComscoreValidation extends MobileCommonConfig{
...
//	@BeforeMethod
	...
	public void verifyCricketNextArticleGA() {
		pages.mobileMalayalamLandingPage.clickOnSportsLnk();   //click on sport link present in home page
		pages.mobileMalayalamSportsPage.clickOnFirstArticleSportsPage();   //It will click on First Article Of sport Page
		pages.gaComscoreValidation.verifyGA();   //It will verify GA is present with 200 status code
	}
