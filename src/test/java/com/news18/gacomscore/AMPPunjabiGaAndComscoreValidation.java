...
public class AMPPunjabiGaAndComscoreValidation extends MobileCommonConfig{
...
//	@Test
	...
	public void verifyCricketNextArticleGA() {
		pages.mobilePunjabLandingPage.clickOnSportsSection();//It will click on First Article Of sports Page
		pages.mobilePunjabCricketNextPage.clickSportsFirstArticle();
		changeToAmpURL();
		pages.gaComscoreAMPValidation.verifyGA();//It will verify GA is present with 200 status code
	}
	...
	public void verifyPhotosFirstArticleGA() {
		...
		pages.mobilePunjabPhotogalleryConsumptionPage.clickPhotogalleryFirstArticle();//It will click on First Article Of photo gallery consumption Page
		changeToAmpURL();
		pages.gaComscoreAMPValidation.verifyGA();//It will verify GA is present with 200 status code
	}
