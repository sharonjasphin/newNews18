 ...
 */
public class MobileBengaliSocialShareLnksValidationTest extends MobileCommonConfig {
...
//	}
	...
	public void verifySocialShareLnksOnArticlePage()
	{
		...
		pages.verifySocialShareIcons.verifySocialMediaNavigation(pages.mobileBengaliArticleConsumptionPage.getSocialShareIconsLnk(), pages.mobileBengaliArticleConsumptionPage.getAllShareIcons());
	}
	...
	public void verifySocialShareLnksOnPhotoGalleryPage()
	{
		...
		pages.verifySocialShareIcons.verifySocialMediaNavigation(pages.mobileBengaliPhotogalleryConsumptionPage.getSocialShareIconsLnk(), pages.mobileBengaliPhotogalleryConsumptionPage.getAllShareIcons());
	}
